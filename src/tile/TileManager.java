...
//			setup(51, "sungai6", true);
			...
			setup(37, "portal", false);
			setup(38, "tile050", false);
			setup(39, "portal", false);

			setup(40, "portal", false);
			setup(41, "portal", false);
			...
			setup(53, "portal", false);
			setup(54, "portal", false);
			setup(55, "portal", false);
			setup(56, "portal", false);
			setup(57, "tile076", false);
			setup(58, "portal", false);
			...
			setup(89, "portal", false);

			setup(90, "portal", false);
			setup(91, "portal", false);
			setup(92, "portal", false);
			...
			setup(103, "portal", false);
			setup(104, "portal", false);
			setup(105, "portal", false);
